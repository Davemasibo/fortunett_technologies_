...
public abstract class Hilt_PackagesBrowserFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PackagesBrowserFragment() {
    super();
  }

  Hilt_PackagesBrowserFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PackagesBrowserFragment_GeneratedInjector) this.generatedComponent()).injectPackagesBrowserFragment(UnsafeCasts.<PackagesBrowserFragment>unsafeCast(this));
    }
  }
