...
public abstract class Hilt_PayFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PayFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PayFragment_GeneratedInjector) this.generatedComponent()).injectPayFragment(UnsafeCasts.<PayFragment>unsafeCast(this));
    }
  }
