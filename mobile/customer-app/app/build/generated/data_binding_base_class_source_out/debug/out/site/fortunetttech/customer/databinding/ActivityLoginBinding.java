...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final TextInputEditText etSubdomain;
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.etSubdomain;
      TextInputEditText etSubdomain = ViewBindings.findChildViewById(rootView, id);
      if (etSubdomain == null) {
        break missingId;
      }
      ...
      return new ActivityLoginBinding((ScrollView) rootView, btnLogin, etPassword, etSubdomain,
          etUsername, progressBar, tvError);
    }
