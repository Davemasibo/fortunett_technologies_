...
public final class ItemPaymentBinding implements ViewBinding {
  ...
  private ItemPaymentBinding(@NonNull MaterialCardView rootView, @NonNull TextView tvAmount,
      @NonNull TextView tvClientName, @NonNull TextView tvDate, @NonNull TextView tvMethod,
      @NonNull TextView tvStatus, @NonNull View viewStatusBar) {
  ...
  public static ItemPaymentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemPaymentBinding((MaterialCardView) rootView, tvAmount, tvClientName, tvDate,
          tvMethod, tvStatus, viewStatusBar);
    }
