...
public final class DaggerAdminApp_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends AdminApp_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.clientListViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // site.fortunetttech.admin.ui.clients.ClientListViewModel 
          return (T) new ClientListViewModel(singletonCImpl.clientRepositoryProvider.get());

          case 1: // site.fortunetttech.admin.ui.dashboard.DashboardViewModel 
          return (T) new DashboardViewModel(singletonCImpl.dashboardRepositoryProvider.get());

          case 2: // site.fortunetttech.admin.ui.auth.LoginViewModel 
  ...
  private static final class SingletonCImpl extends AdminApp_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.dashboardRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<DashboardRepository>(singletonCImpl, 3));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 3: // site.fortunetttech.admin.data.repository.DashboardRepository 
          return (T) new DashboardRepository(singletonCImpl.provideApiServiceProvider.get());

          case 4: // site.fortunetttech.admin.data.repository.AuthRepository 
