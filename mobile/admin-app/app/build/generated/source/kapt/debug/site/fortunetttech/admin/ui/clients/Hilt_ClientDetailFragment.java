...
public abstract class Hilt_ClientDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ClientDetailFragment() {
    super();
  }

  Hilt_ClientDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClientDetailFragment_GeneratedInjector) this.generatedComponent()).injectClientDetailFragment(UnsafeCasts.<ClientDetailFragment>unsafeCast(this));
    }
  }
