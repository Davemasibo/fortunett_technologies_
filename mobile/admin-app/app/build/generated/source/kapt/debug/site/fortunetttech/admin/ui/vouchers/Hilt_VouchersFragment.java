...
public abstract class Hilt_VouchersFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VouchersFragment() {
    super();
  }

  Hilt_VouchersFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VouchersFragment_GeneratedInjector) this.generatedComponent()).injectVouchersFragment(UnsafeCasts.<VouchersFragment>unsafeCast(this));
    }
  }
