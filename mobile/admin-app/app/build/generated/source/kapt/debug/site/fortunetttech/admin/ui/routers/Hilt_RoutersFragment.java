...
public abstract class Hilt_RoutersFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RoutersFragment() {
    super();
  }

  Hilt_RoutersFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RoutersFragment_GeneratedInjector) this.generatedComponent()).injectRoutersFragment(UnsafeCasts.<RoutersFragment>unsafeCast(this));
    }
  }
