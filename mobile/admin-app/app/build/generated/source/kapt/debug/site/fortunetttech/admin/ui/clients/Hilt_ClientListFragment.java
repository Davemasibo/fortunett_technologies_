...
public abstract class Hilt_ClientListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ClientListFragment() {
    super();
  }

  Hilt_ClientListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClientListFragment_GeneratedInjector) this.generatedComponent()).injectClientListFragment(UnsafeCasts.<ClientListFragment>unsafeCast(this));
    }
  }
